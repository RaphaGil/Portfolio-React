        ...
        <div className="clearfix p-5 col-sm-12 col-md-12 col-lg-12 d-flex text-center align-items-center justify-content-center flex-column flex-md-row">
          ...
          <div className="body">
            ...
            <p className="text-light-emphasis form-control-lg">
              I am <b>Raphaela Gil</b> &#128075; and I am a front-end web
              developer based in London, UK
            </p>
            <p className="text-light-emphasis">
              Welcome to my <b>portfolio</b>. This is my webpage where I share
              side projects that I've been working on.
            </p>
          </div>
        </div>
      </section>
